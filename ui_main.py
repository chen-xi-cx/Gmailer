...
################################################################################
## Form generated from reading UI file 'maincwQpla.ui'
##
...
"border:none;")
        ...
        self.my_email_entry.setMinimumSize(QSize(1000, 30))
        font3 = QFont()
        font3.setPointSize(12)
        self.my_email_entry.setFont(font3)
...
"color: rgb(113, 112, 114);")
        ...
        self.my_password_entry.setMinimumSize(QSize(1000, 30))
        self.my_password_entry.setFont(font3)
...
"border:none;")
        ...
        self.gridLayout_3.addWidget(self.to_error, 1, 0, 1, 1)
        ...
        self.browse_file_btn.setFont(font3)
...
"}")
        ...
        self.gridLayout_3.addWidget(self.browse_file_btn, 0, 1, 1, 1)
        ...
        self.to_email_label.setMinimumSize(QSize(300, 20))
        self.to_email_label.setFont(font)
...
"padding-bottom: 5px;")
        ...
        self.gridLayout_3.addWidget(self.to_email_label, 0, 0, 1, 1)
        ...
        self.column_name_entry.setMinimumSize(QSize(200, 33))
        self.column_name_entry.setFont(font3)
...
"padding-bottom: 5px;")
        ...
        self.subject_entry = QLineEdit(self.frame)
        self.subject_entry.setObjectName(u"subject_entry")
        self.subject_entry.setMinimumSize(QSize(1000, 50))
        self.subject_entry.setFont(font3)
...
"padding-bottom: 5px;")
        ...
        self.verticalLayout_6.addWidget(self.subject_entry)

        self.msg_entry = QTextEdit(self.frame)
        self.msg_entry.setObjectName(u"msg_entry")
        self.msg_entry.setMinimumSize(QSize(100, 33))
        self.msg_entry.setFont(font3)
...
"}")
        ...
        self.attached_file_frame = QFrame(self.frame_6)
        self.attached_file_frame.setObjectName(u"attached_file_frame")
        self.attached_file_frame.setFrameShape(QFrame.StyledPanel)
        self.attached_file_frame.setFrameShadow(QFrame.Raised)

        self.horizontalLayout_7.addWidget(self.attached_file_frame)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Gmail", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Gmail", None))
        ...
        self.to_email_label.setText(QCoreApplication.translate("MainWindow", u"To", None))
